-- These commands only really work on Snowflake, so they are just fro writing practice
USE ROLE SYSADMIN;
...
ALTER WAREHOUSE XSMALL_WAREHOUSE SET COMMENT = 'Adding a comment to the warehouse';
...
ALTER WAREHOUSE XSMALL_WAREHOUSE SET COMMENT = 'My firs extra small warehouse';
